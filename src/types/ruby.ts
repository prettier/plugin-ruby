...
export type Massign = ParserEvent<"massign", { target: Mlhs | MlhsAddPost | MlhsParen, value: AnyNode }>;
export type Mlhs = ParserEvent<"mlhs", { parts: (ArefField | Field | Identifier | MlhsParen | VarField)[], comma: undefined | true }>;
export type MlhsAddPost = ParserEvent<"mlhs_add_post", { star: Mlhs, mlhs: Mlhs }>;
export type MlhsParen = ParserEvent<"mlhs_paren", { cnts: Mlhs | MlhsAddPost | MlhsParen }>;
