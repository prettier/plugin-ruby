...
describe("assign", () => {
  ...
  describe("breaking", () => {
    ...
    test("arrays don't get force indented", () => (
      expect(`a = [${long}, ${long}, ${long}]`).toChangeFormat(ruby(`
        a = [
          ${long},
          ${long},
          ${long}
    ...
    test("hashes don't get force indented", () => (
      expect(`a = { a: ${long}, b: ${long}, c: ${long} }`).toChangeFormat(ruby(`
        a = {
          a:
            ${long},
          b:
    ...
    test("chained methods on array literals don't get oddly indented", () => (
      expect(`a = [${long}].freeze`).toChangeFormat(ruby(`
        a = [
          ${long}
        ].freeze
      `))
    ...
    test("chained methods on hash literals don't get oddly indented", () => (
      expect(`a = { a: ${long} }.freeze`).toChangeFormat(ruby(`
        a = {
          a:
            ${long}
        }.freeze
